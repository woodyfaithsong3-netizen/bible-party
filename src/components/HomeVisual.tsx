          ...
          {wide ? <View style={styles.desktopBody}>
            ...
            <View style={styles.desktopPanel}>
              ...
              <View style={styles.desktopActions}>
                ...
                <Pressable onPress={() => router.push('/game?modes=quiz,mystery,truefalse,challenge,quote,intruder,timesup,threeclues,forbidden,faceoff,risk&duration=2&teams=Équipe%20A|Équipe%20B')} style={({ pressed }) => [styles.desktopAction, styles.desktopActionQuick, pressed && styles.pressed]}>
