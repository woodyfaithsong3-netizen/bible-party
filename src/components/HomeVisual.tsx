...
'}la Bible</Text></View>
            ...
            <Pressable onPress={() => router.push('/bible')} style={({ pressed }) => [styles.play, compact && styles.playCompact, shortPhone && styles.playShort, pressed && styles.pressed]}><View style={[styles.playIcon, compact && styles.playIconCompact]}><Image source={iconBible} style={[styles.playAsset, compact && styles.playAssetCompact]} resizeMode="contain" /></View><View style={styles.playCopy}><Text style={[styles.playTitle, compact && styles.playTitleCompact]}>Ma Bible</Text><Text style={[styles.playSubtitle, compact && styles.playSubtitleCompact]}>Ta collection et ta progression</Text></View><Text style={styles.arrow}>›</Text></Pressable>
          </>}
