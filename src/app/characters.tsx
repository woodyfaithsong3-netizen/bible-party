...
const CHRONOLOGICAL_BLOCKS = [
  ...
  { label: 'Moïse & l’Exode', start: 'moise', end: 'balak' },
  { label: 'Époque des Juges', start: 'ruth', end: 'samuel' },
  ...
  { label: 'Avant Jésus', start: 'elizabeth', end: 'jean-baptiste' },
  { label: 'Jésus & son ministère', start: 'joseph_caiaphas', end: 'mary_mother_james' },
  { label: 'Débuts du christianisme', start: 'stephen', end: 'priscilla' },
  { label: 'Congrégations chrétiennes', start: 'lydia', end: 'epaphroditus' },
] as const;
