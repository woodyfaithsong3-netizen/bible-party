...
const v101ExpertQuiz: QuizQuestion[] = [
  ...
  {id:'v101-expert-q-12',type:'quiz',category:'Prophéties',difficulty:'hard',question:'Quel prophète a vu une corbeille de fruits d’été dans une vision annonçant la fin pour Israël ?',answers:['Amos','Zacharie','Aggée','Joël'],correctAnswer:0,explanation:'La vision de la corbeille de fruits d’été est rapportée par Amos et annonce que la fin est venue pour le peuple d’Israël.'},
];

const v101ExpertTrueFalse: TrueFalseQuestion[] = [
  {id:'v101-expert-tf-01',type:'truefalse',category:'Personnages',difficulty:'hard',statement:'Ébed-Mélek était un Éthiopien qui intervint pour sauver Jérémie de la citerne.',answer:true,explanation:'Il parla au roi et fit sortir Jérémie de la citerne avec des hommes et des cordes.'},
  {id:'v101-expert-tf-02',type:'truefalse',category:'Personnages',difficulty:'hard',statement:'Houlda était la prophétesse consultée après la découverte du livre de la Loi sous Josias.',answer:true,explanation:'Les envoyés du roi Josias consultèrent Houlda au sujet du livre retrouvé.'},
  ...
  {id:'v101-expert-tf-07',type:'truefalse',category:'Prophéties',difficulty:'hard',statement:'Amos a rapporté une vision d’une corbeille de fruits d’été.',answer:true,explanation:'Cette vision annonçait que la fin était venue pour Israël.'},
...
const v101ExpertMystery: MysteryQuestion[] = [
  {id:'v101-expert-m-01',type:'mystery',category:'Personnages',difficulty:'hard',answer:'Ébed-Mélek',clues:['Éthiopien','Citerne','Jérémie'],explanation:'Ébed-Mélek a fait sortir Jérémie de la citerne.'},
  {id:'v101-expert-m-02',type:'mystery',category:'Personnages',difficulty:'hard',answer:'Houlda',clues:['Prophétesse','Livre de la Loi','Josias'],explanation:'Houlda a transmis la réponse de Jéhovah après la découverte du livre de la Loi.'},
...
const v101ExpertQuotes: QuoteQuestion[] = [
  ...
  {id:'v101-expert-qte-05',type:'quote',category:'Évangiles',difficulty:'hard',quote:'Quel disciple a dit : « Allons-y, nous aussi, pour mourir avec lui » ?',answers:['Thomas','Pierre','Jean','André'],correctAnswer:0,explanation:'Thomas prononça ces paroles lorsque Jésus décida de retourner en Judée.'},
...
const v101ExpertTimesUp: TimesUpQuestion[] = [
  {id:'v101-expert-tu-01',type:'timesup',category:'Personnages',difficulty:'hard',answer:'Ébed-Mélek',clues:['Éthiopien','Citerne','Jérémie']},
  {id:'v101-expert-tu-02',type:'timesup',category:'Personnages',difficulty:'hard',answer:'Houlda',clues:['Prophétesse','Loi retrouvée','Josias']},
...
const v101ExpertChallenges: Challenge[] = [
  {id:'v101-expert-c-01',type:'challenge',category:'Personnages',difficulty:'hard',prompt:'En 10 secondes : nommez le prophète qui a rapporté la vision de la corbeille de fruits d’été.',seconds:10,acceptedAnswers:['Amos'] },
  {id:'v101-expert-c-02',type:'challenge',category:'Personnages',difficulty:'hard',prompt:'En 10 secondes : quel Éthiopien a sauvé Jérémie de la citerne ?',seconds:10,acceptedAnswers:['Ébed-Mélek'] },
  {id:'v101-expert-c-03',type:'challenge',category:'Rois & prophètes',difficulty:'hard',prompt:'En 10 secondes : quel roi a été consulté après la découverte du livre de la Loi, en faisant demander une réponse à Houlda ?',seconds:10,acceptedAnswers:['Josias'] },
