...
const facts: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Qui a vaincu Goliath ?', ['Saül', 'David', 'Jonathan', 'Joab'], 1, 'David a frappé Goliath avec une pierre lancée avec sa fronde.', '1 Samuel 17:45-50', 'Personnages'],
...
const extraFacts: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quelle femme a caché les espions israélites à Jéricho ?', ['Déborah', 'Ruth', 'Jaël', 'Rahab'], 3, 'Rahab a caché les deux espions et les a aidés à repartir.', 'Josué 2:1-14', 'Personnages'],
  ...
  ['Quel disciple était le frère de Simon Pierre ?', ['Philippe', 'Thomas', 'Matthieu', 'André'], 3, 'André était le frère de Simon Pierre.', 'Matthieu 4:18-20', 'Évangiles'],
