...
const extraFacts: Array<[string, string[], number, string, string, string]> = [
  ['Quel homme a reçu le nom d’Israël après une nuit de lutte ?', ['Isaac', 'Jacob', 'Ésaü', 'Joseph'], 1, 'Jacob a reçu le nom Israël après cet épisode.', 'Genèse 32:24-28', 'Personnages'],
  ...
  ['Qui était la femme qu’Abraham a envoyée chercher pour Isaac ?', ['Rachel', 'Léa', 'Abigaïl', 'Rébecca'], 3, 'Rébecca a été choisie comme femme pour Isaac.', 'Genèse 24:10-20, 58-67', 'Personnages'],
  ...
  ['Quel homme a interprété des rêves alors qu’il était prisonnier en Égypte ?', ['Moïse', 'Joseph', 'Daniel', 'Néhémie'], 1, 'Joseph a interprété les rêves de deux serviteurs de Pharaon.', 'Genèse 40:1-23', 'Personnages'],
  ['Quel patriarche a été enterré dans la grotte de Makpéla ?', ['Moïse', 'Samuel', 'Abraham', 'David'], 2, 'Abraham a été enterré avec Sara dans la grotte de Makpéla.', 'Genèse 25:7-10', 'Personnages'],
  ['Quel signe a attiré l’attention de Moïse au début de sa mission ?', ['Une colonne de feu', 'Un éclair', 'Une nuée de sauterelles', 'Un buisson ardent'], 3, 'Moïse a vu un buisson en feu qui ne brûlait pas.', 'Exode 3:1-6', 'Bible'],
  ...
  ['Quel événement a marqué le départ des Israélites hors d’Égypte ?', ['La chute de Jéricho', 'La Pâque et la dixième plaie', 'La construction du temple', 'La division du royaume'], 1, 'La Pâque a précédé le départ d’Israël hors d’Égypte.', 'Exode 12:1-42', 'Histoire biblique'],
  ...
  ['Quelle prophétesse jugeait Israël à l’époque de Barak ?', ['Houlda', 'Déborah', 'Miriam', 'Anne'], 1, 'Déborah jugeait Israël et a soutenu Barak.', 'Juges 4:4-10', 'Rois & prophètes'],
  ...
  ['Quel homme était chef de l’armée de Jabîn ?', ['Barak', 'Gédéon', 'Jephté', 'Sissera'], 3, 'Sissera commandait l’armée du roi Jabîn.', 'Juges 4:2-3', 'Rois & prophètes'],
  ...
  ['Quelle femme a évité à David de commettre une faute grave contre Nabal ?', ['Mikal', 'Abigaïl', 'Anne', 'Betsabée'], 1, 'Abigaïl a parlé avec sagesse et a empêché David d’agir sous le coup de la colère.', '1 Samuel 25:14-35', 'Personnages'],
  ...
  ['Quel prophète a reçu de la nourriture apportée par des corbeaux pendant une période de sécheresse ?', ['Élisée', 'Isaïe', 'Jérémie', 'Élie'], 3, 'Jéhovah a utilisé des corbeaux pour fournir de la nourriture à Élie.', '1 Rois 17:2-6', 'Rois & prophètes'],
  ...
  ['Quel prophète est devenu le successeur d’Élie ?', ['Isaïe', 'Élisée', 'Jérémie', 'Ézéchiel'], 1, 'Élisée a été désigné pour succéder à Élie.', '1 Rois 19:19-21', 'Rois & prophètes'],
  ...
  ['Quel roi de Juda a fait détruire le serpent de cuivre devenu un objet de culte ?', ['Josias', 'Josaphat', 'Roboam', 'Ézéchias'], 3, 'Ézéchias a détruit le serpent de cuivre parce que le peuple lui offrait de l’encens.', '2 Rois 18:1-4', 'Rois & prophètes'],
  ...
  ['Qui a découvert le livre de la Loi lors des réparations du temple sous Josias ?', ['Ézéchias', 'Hilqiya', 'Néhémie', 'Esdras'], 1, 'Le prêtre en chef Hilqiya a trouvé le livre de la Loi.', '2 Rois 22:8-11', 'Rois & prophètes'],
  ['Quel roi a pris des mesures énergiques pour éliminer l’idolâtrie en Juda ?', ['Achaz', 'Manassé', 'Josias', 'Roboam'], 2, 'Josias a soutenu une réforme de la vraie adoration.', '2 Rois 23:4-20', 'Rois & prophètes'],
  ...
  ['Quel disciple a été appelé alors qu’il réparait des filets avec son frère ?', ['Matthieu', 'Thomas', 'André', 'Jude'], 2, 'André était avec Simon Pierre et réparait les filets lorsqu’ils ont été appelés.', 'Matthieu 4:18-20', 'Évangiles'],
  ['Quel disciple était le frère de Simon Pierre et a été l’un des premiers à lui parler de Jésus ?', ['Philippe', 'Thomas', 'Matthieu', 'André'], 3, 'André était le frère de Simon Pierre.', 'Matthieu 4:18-20', 'Évangiles'],
  ['Selon Matthieu, combien de temps Jésus a-t-il jeûné dans le désert avant sa tentation ?', ['40 jours', '7 jours', '12 jours', '3 jours'], 0, 'Jésus a jeûné 40 jours et 40 nuits dans le désert.', 'Matthieu 4:1-2', 'Évangiles'],
  ['Quels trois apôtres ont accompagné Jésus lors de la transfiguration ?', ['Pierre, André et Matthieu', 'Pierre, Jacques et Jean', 'Jean, Thomas et Philippe', 'Jacques, Jude et Barthélémy'], 1, 'Pierre, Jacques et Jean étaient présents lors de la transfiguration.', 'Matthieu 17:1-5', 'Évangiles'],
  ...
  ['Quel miracle est associé à une pièce trouvée dans la bouche d’un poisson ?', ['La multiplication des pains', 'La guérison d’un aveugle', 'La pêche miraculeuse', 'Le paiement de l’impôt'], 3, 'Jésus a indiqué à Pierre comment trouver une pièce dans la bouche d’un poisson pour payer l’impôt.', 'Matthieu 17:24-27', 'Évangiles'],
  ['Quel homme paralysé a été amené à Jésus après que ses amis ont ouvert le toit ?', ['Un paralysé à Capharnaüm', 'Lazare', 'Bartimée', 'Le serviteur du centurion'], 0, 'Quatre hommes ont fait descendre un paralysé à travers le toit.', 'Marc 2:1-12', 'Évangiles'],
  ...
  ['Quelle parabole de Jésus illustre la joie de retrouver ce qui avait été égaré ?', ['Le semeur', 'Les dix vierges', 'La brebis perdue', 'Le bon Samaritain'], 2, 'Jésus a utilisé l’exemple d’une brebis perdue pour illustrer la valeur de retrouver ce qui est perdu.', 'Luc 15:3-7', 'Évangiles'],
  ['Quelle parabole raconte l’accueil d’un père envers son fils qui revient après avoir quitté sa maison ?', ['Les talents', 'Le bon Samaritain', 'Le riche insensé', 'Le fils perdu'], 3, 'Le père accueille avec joie son fils qui revient.', 'Luc 15:11-24', 'Évangiles'],
  ...
  ['Dans quelle ville a eu lieu le mariage où Jésus a changé de l’eau en vin ?', ['Béthanie', 'Jéricho', 'Cana', 'Nazareth'], 2, 'Le premier miracle rapporté par Jean a eu lieu à Cana en Galilée.', 'Jean 2:1-11', 'Évangiles'],
  ['Combien de jarres en pierre étaient présentes au mariage de Cana ?', ['Deux', 'Douze', 'Sept', 'Six'], 3, 'Jean mentionne six grandes jarres en pierre.', 'Jean 2:6-9', 'Évangiles'],
  ...
  ['Dans quel bassin l’homme né aveugle devait-il se laver ?', ['Béthesda', 'Jourdain', 'Siloé', 'Kédrôn'], 2, 'Jésus lui a demandé de se laver au bassin de Siloé.', 'Jean 9:6-7', 'Évangiles'],
  ...
  ['Quelle qualité est décrite comme patiente et bonne dans 1 Corinthiens 13 ?', ['La foi', 'L’amour', 'La connaissance', 'La richesse'], 1, 'Paul explique les qualités de l’amour chrétien.', '1 Corinthiens 13:4-7', 'Bible'],
...
const extraFacts2: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quel fils de Jacob a reçu un vêtement spécial de son père ?', ['Benjamin', 'Joseph', 'Juda', 'Ruben'], 1, 'Jacob aimait particulièrement Joseph et lui avait fait un vêtement spécial.', 'Genèse 37:3-4', 'Personnages'],
  ...
  ['Quel prophète a été emporté dans une tempête de vent sous les yeux d’Élisée ?', ['Ésaïe', 'Élie', 'Jérémie', 'Samuel'], 1, 'Élie a été emporté dans une tempête de vent et Élisée a vu l’événement.', '2 Rois 2:1-12', 'Rois & prophètes'],
...
const extraFacts3: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quel juge a vaincu les Madianites avec seulement 300 hommes ?', ['Samson', 'Gédéon', 'Éhoud', 'Barak'], 1, 'Gédéon a conduit une force réduite à 300 hommes.', 'Juges 7:2-7', 'Rois & prophètes'],
  ...
  ['Quel roi a reçu la visite de la reine de Saba ?', ['David', 'Salomon', 'Ézéchias', 'Josias'], 1, 'La reine de Saba est venue éprouver la sagesse de Salomon.', '1 Rois 10:1-10', 'Rois & prophètes'],
  ['Quel prophète a été nourri par des corbeaux pendant une période de sécheresse ?', ['Élisée', 'Jérémie', 'Élie', 'Isaïe'], 2, 'Jéhovah a utilisé des corbeaux pour nourrir Élie.', '1 Rois 17:2-6', 'Rois & prophètes'],
...
const extraFacts4: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quel fils de Jacob est devenu gouverneur en Égypte après avoir interprété les rêves de Pharaon ?', ['Juda', 'Benjamin', 'Joseph', 'Ruben'], 2, 'Joseph a été établi au-dessus du pays d’Égypte pour gérer les réserves.', 'Genèse 41:37-43', 'Personnages'],
  ['Quel homme a lutté toute une nuit et a reçu le nom Israël ?', ['Ésaü', 'Moïse', 'Josué', 'Jacob'], 3, 'Jacob a reçu le nom Israël après cet épisode.', 'Genèse 32:24-28', 'Personnages'],
  ['Qui était le frère jumeau de Jacob ?', ['Ésaü', 'Joseph', 'Benjamin', 'Juda'], 0, 'Ésaü et Jacob étaient jumeaux.', 'Genèse 25:24-26', 'Personnages'],
  ['Quel homme a interprété le rêve de Pharaon annonçant sept années d’abondance puis sept années de famine ?', ['Daniel', 'Joseph', 'Samuel', 'Esdras'], 1, 'Joseph a expliqué les rêves de Pharaon.', 'Genèse 41:14-32', 'Personnages'],
  ...
  ['Quel juge a été utilisé par Jéhovah pour vaincre Madian avec seulement 300 hommes ?', ['Barak', 'Jephté', 'Gédéon', 'Samson'], 2, 'L’armée de Gédéon a été réduite à 300 hommes.', 'Juges 7:2-7', 'Rois & prophètes'],
  ...
  ['Quel roi a demandé à Jéhovah de lui donner un cœur obéissant pour juger le peuple ?', ['David', 'Salomon', 'Josias', 'Ézéchias'], 1, 'Salomon a demandé sagesse et discernement.', '1 Rois 3:5-12', 'Rois & prophètes'],
  ['Quel prophète a été successeur d’Élie ?', ['Isaïe', 'Jérémie', 'Élisée', 'Ézéchiel'], 2, 'Élisée a été choisi pour succéder à Élie.', '1 Rois 19:19-21', 'Rois & prophètes'],
  ...
  ['Quel homme a été jeté dans une fosse aux lions après avoir continué à prier ?', ['Jérémie', 'Daniel', 'Ézéchiel', 'Néhémie'], 1, 'Daniel a continué à prier malgré l’interdiction du roi.', 'Daniel 6:7-23', 'Personnages'],
...
const jwQuizExpansion: Array<[string, string[], number, string, string, string]> = [
  ['Qui a reçu les instructions de construire l’arche de l’Alliance ?', ['David', 'Josué', 'Salomon', 'Moïse'], 3, 'Moïse a reçu les instructions concernant le tabernacle et l’arche.', 'Exode 25:8-22', 'Bible'],
  ...
  ['Quel homme a construit le temple après avoir reçu les préparatifs de David ?', ['Zorobabel', 'Salomon', 'Néhémie', 'Ézéchias'], 1, 'Salomon a construit le premier temple à Jérusalem.', '1 Rois 6:1, 14', 'Rois & prophètes'],
  ['Quel roi a organisé une grande célébration lors de l’inauguration du temple ?', ['David', 'Josias', 'Salomon', 'Ézéchias'], 2, 'Salomon a inauguré le temple avec une grande assemblée.', '1 Rois 8:1-11, 62-66', 'Rois & prophètes'],
  ...
  ['Quel apôtre a signalé à Jésus le garçon qui avait cinq pains et deux poissons ?', ['Philippe', 'Thomas', 'Matthieu', 'André'], 3, 'André a signalé à Jésus le garçon qui avait cinq pains et deux poissons.', 'Jean 6:5-13', 'Évangiles'],
];
...
const tfFacts3: Array<[string, boolean, string, string]> = [
  ['Josué a envoyé deux espions à Jéricho avant la prise de la ville.', true, 'Josué a envoyé deux hommes espionner le pays, notamment Jéricho.', 'Josué 2:1-4'],
...
const baseIntruderQuestions: IntruderQuestion[] = [
  { id:'intruder-1', type:'intruder', category:'Personnages', difficulty:'medium', items:['Noé','Abraham','Moïse','Jonas'], intruder:3, explanation:'Jonas appartient à une période bien plus tardive ; les trois autres sont des personnages de la période patriarcale ou de l’Exode.', reference:'Genèse 6:9; 12:1; Exode 2:10; Jonas 1:1-3' },
  ...
  { id:'intruder-3', type:'intruder', category:'Lieux', difficulty:'medium', items:['Bethléhem','Béthanie','Jéricho','Nazareth'], intruder:1, explanation:'Bethléhem, Béthanie et Jéricho sont associés à des épisodes distincts ; Nazareth est ici l’intrus selon le regroupement retenu par cette manche.', reference:'Matthieu 2:1; Jean 11:1; Josué 6:1; Luc 1:26' },
...
const v99ThemeExpansion: QuizQuestion[] = [
  ...
  {id:'v99-science-03',type:'quiz',category:'La Bible et la science',difficulty:'hard',question:'Selon la position présentée dans les ressources JW sur la création, que permet d’admettre la Bible concernant les animaux et les plantes ?',answers:['Des variations et adaptations au sein des espèces','La transformation nécessaire d’une espèce en une autre','L’absence totale de variation','Que toutes les espèces descendent obligatoirement d’une seule forme de vie'],correctAnswer:0,explanation:'La ressource distingue les variations au sein des espèces de l’idée que Dieu aurait utilisé l’évolution pour faire apparaître différentes espèces.',reference:'Genèse 1:12, 21, 25; Révélation 4:11'},
...
{id:'v102-q-04',type:'quiz',category:'La Bible et la science',difficulty:'expert',question:'Selon Job 26:7, quelle description de la Terre est mise en avant dans les ressources JW sur la science et la Bible ?',answers:['Elle est suspendue sur rien','Elle repose sur une colonne','Elle est portée par un animal','Elle est fixée à une montagne'],correctAnswer:0,explanation:'Job 26:7 est cité par JW.org pour évoquer la Terre comme suspendue sur rien.',reference:'Job 26:7'},
