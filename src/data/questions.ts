...
const v50CategoryQuizExpansion: QuizQuestion[] = [
  ...
  { id:'quiz-v50-personnages-02', type:'quiz', category:'Personnages', difficulty:'medium', question:'Qui interpréta les rêves de Pharaon sur les sept années d’abondance et de famine ?', answers:['Joseph','Daniel','Samuel','Esdras'], correctAnswer:0, explanation:'Joseph a expliqué les rêves de Pharaon et proposé une stratégie pour les années de famine.', reference:'Genèse 41:14-36' },
...
quizQuestions.push(
  { id:'quiz-22', type:'quiz', category:'Personnages', difficulty:'medium', question:'Quelle partie de l’équipement de Saül David refusa-t-il avant son combat contre Goliath ?', answers:['L’armure de Saül','La fronde','Le bâton de berger','Le bouclier de Jonathan'], correctAnswer:0, explanation:'David a essayé l’équipement de Saül, mais ne pouvait pas marcher avec et a préféré utiliser sa fronde et cinq pierres.', reference:'1 Samuel 17:38-40' },
