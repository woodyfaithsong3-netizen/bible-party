...
const extraFacts: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quel signe a attiré l’attention de Moïse au début de sa mission ?', ['Un buisson ardent','Une colonne de feu','Un éclair','Une nuée de sauterelles'], 0, 'Moïse a vu un buisson en feu qui ne brûlait pas.', 'Exode 3:1-6', 'Bible'],
