...
const extraFacts: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quelle parabole de Jésus raconte l’histoire d’une brebis qu’un berger retrouve après l’avoir perdue ?', ['La brebis perdue','Le semeur','Les dix vierges','Le bon Samaritain'], 0, 'Jésus a utilisé l’exemple d’une brebis perdue pour illustrer la valeur de retrouver ce qui est perdu.', 'Luc 15:3-7', 'Évangiles'],
  ...
  ['Quel homme Jésus a-t-il guéri à Jérusalem après avoir rencontré cet homme aveugle depuis sa naissance ?', ['Un homme né aveugle','Bartimée','Zachée','Un paralysé'], 0, 'Jésus a guéri un homme qui était aveugle depuis sa naissance.', 'Jean 9:1-7', 'Évangiles'],
