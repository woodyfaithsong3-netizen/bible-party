...
const extraFacts: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quel roi a célébré une Pâque exceptionnelle après sa réforme de la vraie adoration ?', ['Josias', 'Ézéchias', 'Asa', 'Josaphat'], 0, 'Josias organisa une grande célébration de la Pâque après avoir éliminé de nombreux objets liés au faux culte.', '2 Rois 23:21-23', 'Rois & prophètes'],
  ...
  ['Quel disciple a présenté Nathanaël à Jésus après lui avoir dit : « Viens et vois » ?', ['André', 'Philippe', 'Pierre', 'Jean'], 1, 'Philippe a invité Nathanaël à venir voir Jésus.', 'Jean 1:43-46', 'Évangiles'],
