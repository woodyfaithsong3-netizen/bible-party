...
const baseQuoteQuestions: QuoteQuestion[] = [
  ...
  { id:'quote-3', type:'quote', category:'Disciples', difficulty:'medium', quote:'Après que beaucoup de disciples se sont retirés, quel apôtre a déclaré qu’il n’avait personne d’autre vers qui aller ?', answers:['Pierre','Thomas','Jean','Philippe'], correctAnswer:0, explanation:'Pierre a exprimé sa confiance en Jésus lorsque beaucoup d’autres disciples se sont retirés.', reference:'Jean 6:66-69' },
