...
const extraFacts: Array<[string, string[], number, string, string, string]> = [
  ...
  ['De quelle ville Philippe était-il originaire ?', ['Bethsaïda', 'Nazareth', 'Jéricho', 'Béthanie'], 0, 'Philippe était originaire de Bethsaïda, la ville de Pierre et d’André.', 'Jean 1:44', 'Évangiles'],
...
const extraFacts3: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Comment s’appelait le chef de synagogue dont la fille était malade ?', ['Nicodème', 'Zachée', 'Jairus', 'Simon'], 2, 'Jairus a demandé à Jésus de venir auprès de sa fille.', 'Marc 5:21-24, 35-43', 'Évangiles'],
  ...
  ['Dans quelle ville Jésus a-t-il accompli son premier signe ?', ['Bethléem', 'Béthanie', 'Cana', 'Jéricho'], 2, 'Le mariage de Cana est associé au premier signe rapporté par Jean.', 'Jean 2:1-11', 'Évangiles'],
  ...
  ['Quel prophète encouragea Zorobabel et le peuple à reprendre la reconstruction du temple ?', ['Jonas', 'Amos', 'Nahum', 'Aggée'], 3, 'Aggée a encouragé les Juifs à reprendre la reconstruction du temple.', 'Aggée 1:1-8', 'Rois & prophètes'],
...
const extraFacts4: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quel juge était fils de Galaad et d’une femme prostituée ?', ['Jephté', 'Gédéon', 'Samson', 'Éhoud'], 0, 'Jephté était fils de Galaad et d’une femme prostituée.', 'Juges 11:1', 'Rois & prophètes'],
  ['Quel fils de Saül a conclu une alliance d’amitié avec David ?', ['Joab', 'Abner', 'Absalom', 'Jonathan'], 3, 'Jonathan, fils de Saül, était profondément attaché à David.', '1 Samuel 18:1-4', 'Personnages'],
  ...
  ['Quel prophète a encouragé les Juifs à reprendre le travail sur le temple après l’exil ?', ['Amos', 'Nahum', 'Jonas', 'Aggée'], 3, 'Aggée a encouragé le peuple à reprendre les travaux du temple.', 'Aggée 1:1-8', 'Rois & prophètes'],
  ...
  ['Quel disciple trouva le garçon qui avait cinq pains et deux poissons ?', ['André', 'Philippe', 'Pierre', 'Thomas'], 0, 'André a signalé à Jésus la présence du garçon avec les pains et les poissons.', 'Jean 6:5-9', 'Évangiles'],
...
const jwQuizExpansion: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Chez quelle femme Sissera s’est-il réfugié ?', ['Déborah', 'Ruth', 'Jaël', 'Abigaïl'], 2, 'Sissera s’est réfugié chez Jaël, qui l’a ensuite tué.', 'Juges 4:17-22', 'Personnages'],
...
const quoteQuestions4: QuoteQuestion[] = [
  ...
  { id:'quote-25', type:'quote', category:'Bible & enseignements', difficulty:'hard', quote:'Quel roi a déchiré ses vêtements après avoir entendu les paroles du livre de la Loi retrouvé dans le temple ?', answers:['Josias','Ézéchias','David','Salomon'], correctAnswer:0, explanation:'Josias a réagi avec humilité après avoir entendu les paroles du livre de la Loi.', reference:'2 Rois 22:8-13' },
];
...
const v39QuizExpansion: QuizQuestion[] = [
  ...
  { id:'quiz-v39-10', type:'quiz', category:'Actes', difficulty:'medium', question:'Où Paul et Silas furent-ils emprisonnés avant le tremblement de terre ?', answers:['Philippes','Jérusalem','Antioche','Joppé'], correctAnswer:0, explanation:'Paul et Silas étaient emprisonnés à Philippes lorsqu’un tremblement de terre a ouvert les portes.', reference:'Actes 16:12, 22-26' },
  ...
  { id:'quiz-v39-16', type:'quiz', category:'Bible', difficulty:'medium', question:'Quel livre raconte les débuts de l’activité chrétienne ?', answers:['Actes','Psaumes','Proverbes','Ruth'], correctAnswer:0, explanation:'Le livre des Actes retrace le développement de l’activité chrétienne au premier siècle.', reference:'Actes 1:8; 2:1-4' },
  { id:'quiz-v39-17', type:'quiz', category:'Personnages', difficulty:'hard', question:'Qui interpréta l’écriture sur le mur au festin de Belshatsar ?', answers:['Daniel','Néhémie','Esdras','Ézéchiel'], correctAnswer:0, explanation:'Daniel a expliqué le message écrit sur le mur.', reference:'Daniel 5:13-28' },
...
const v50CategoryQuizExpansion: QuizQuestion[] = [
  ...
  { id:'quiz-v50-bible-02', type:'quiz', category:'Bible', difficulty:'medium', question:'Qui dirigea la reconstruction des murailles de Jérusalem après l’exil ?', answers:['Néhémie','Esdras','Esther','Chroniques'], correctAnswer:0, explanation:'Le livre de Néhémie décrit notamment cette reconstruction.', reference:'Néhémie 2:11-18; 6:15-16' },
  { id:'quiz-v50-bible-03', type:'quiz', category:'Bible', difficulty:'medium', question:'Quel livre raconte l’histoire de Ruth, ancêtre de David ?', answers:['Ruth','Esther','Juges','Esdras'], correctAnswer:0, explanation:'Le livre de Ruth raconte son parcours et son mariage avec Boaz, dans la lignée de David.', reference:'Ruth 1–4' },
  ...
  { id:'quiz-v50-bible-05', type:'quiz', category:'Bible', difficulty:'medium', question:'Quel roi perse autorisa le retour des Juifs à Jérusalem ?', answers:['Cyrus','Darius','Artaxerxès','Assuérus'], correctAnswer:0, explanation:'Cyrus a publié un décret permettant le retour et la reconstruction.', reference:'Esdras 1:1-4' },
  ...
  { id:'quiz-v50-personnages-02', type:'quiz', category:'Personnages', difficulty:'medium', question:'Qui interpréta les rêves de Pharaon sur l’abondance et la famine ?', answers:['Joseph','Daniel','Samuel','Esdras'], correctAnswer:0, explanation:'Joseph a expliqué les rêves de Pharaon et proposé une stratégie pour les années de famine.', reference:'Genèse 41:14-36' },
  { id:'quiz-v50-personnages-03', type:'quiz', category:'Personnages', difficulty:'easy', question:'Quel jeune homme servit auprès d’Éli avant de recevoir un appel de Jéhovah ?', answers:['Samuel','David','Josué','Timothée'], correctAnswer:0, explanation:'Samuel servait auprès d’Éli lorsqu’il a entendu l’appel de Jéhovah.', reference:'1 Samuel 3:1-10' },
  { id:'quiz-v50-personnages-04', type:'quiz', category:'Personnages', difficulty:'medium', question:'Quelle femme protégea les espions israélites à Jéricho ?', answers:['Rahab','Ruth','Déborah','Esther'], correctAnswer:0, explanation:'Rahab a caché les espions et les a aidés à repartir.', reference:'Josué 2:1-14' },
  { id:'quiz-v50-personnages-05', type:'quiz', category:'Personnages', difficulty:'medium', question:'Qui accompagna Paul et Silas dans plusieurs déplacements ?', answers:['Timothée','Caïphe','Naboth','Mardochée'], correctAnswer:0, explanation:'Timothée s’est joint à Paul et Silas après avoir été recommandé aux frères.', reference:'Actes 16:1-5' },
  ...
  { id:'quiz-v50-rois-03', type:'quiz', category:'Rois & prophètes', difficulty:'medium', question:'Quel roi fit lire le livre de la Loi retrouvé dans le temple ?', answers:['Josias','Manassé','Roboam','Achaz'], correctAnswer:0, explanation:'Le livre de la Loi a été retrouvé pendant le règne de Josias.', reference:'2 Rois 22:8-13' },
  { id:'quiz-v50-rois-04', type:'quiz', category:'Rois & prophètes', difficulty:'medium', question:'Quel prophète dénonça le péché de David avec l’histoire d’une brebis ?', answers:['Nathan','Samuel','Gad','Élie'], correctAnswer:0, explanation:'Nathan a raconté cette illustration pour amener David à reconnaître sa faute.', reference:'2 Samuel 12:1-13' },
  ...
  { id:'quiz-v50-actes-04', type:'quiz', category:'Actes', difficulty:'medium', question:'Qui demanda : « Que dois-je faire pour être sauvé ? » à Philippes ?', answers:['Le geôlier','Corneille','Eutique','Sergius Paulus'], correctAnswer:0, explanation:'Le geôlier de Philippes a posé cette question à Paul et Silas.', reference:'Actes 16:25-34' },
...
quizQuestions.push(
  { id:'quiz-22', type:'quiz', category:'Personnages', difficulty:'medium', question:'Quelle partie de l’équipement de Saül David refusa-t-il avant son combat ?', answers:['L’armure de Saül','La fronde','Le bâton de berger','Le bouclier de Jonathan'], correctAnswer:0, explanation:'David a essayé l’équipement de Saül, mais ne pouvait pas marcher avec et a préféré utiliser sa fronde et cinq pierres.', reference:'1 Samuel 17:38-40' },
  ...
  { id:'quiz-141', type:'quiz', category:'Évangiles', difficulty:'medium', question:'Pourquoi Jésus attendit-il avant d’aller voir Lazare ?', answers:['Pour que la situation conduise à manifester la gloire de Dieu','Parce qu’il ignorait où Lazare se trouvait','Parce qu’il attendait une invitation de Jérusalem','Parce que Lazare avait déjà été enterré depuis des semaines'], correctAnswer:0, explanation:'Jésus a expliqué que cette maladie devait servir à la gloire de Dieu et à la gloire du Fils de Dieu.', reference:'Jean 11:4-6' },
  ...
  { id:'quiz-197', type:'quiz', category:'Personnages', difficulty:'medium', question:'Quelle habitude Daniel conserva-t-il malgré l’interdiction royale ?', answers:['Prier régulièrement en direction de Jérusalem','Quitter Babylone en secret','Refuser toute nourriture du roi','Prêcher publiquement dans les rues'], correctAnswer:0, explanation:'Daniel a continué à prier trois fois par jour comme il en avait l’habitude.', reference:'Daniel 6:7-13' },
  ...
  { id:'quiz-103', type:'quiz', category:'Personnages', difficulty:'medium', question:'Pourquoi les trois Hébreux refusèrent-ils de se prosterner devant la statue ?', answers:['Ils refusaient d’adorer la statue même si le roi les condamnait','Ils pensaient que la statue était trop petite','Ils n’avaient pas entendu la musique','Ils avaient quitté Babylone avant le décret'], correctAnswer:0, explanation:'Ils ont expliqué qu’ils ne serviraient pas les dieux du roi ni n’adoreraient la statue.', reference:'Daniel 3:16-18' },
...
const v101ExpertQuiz: QuizQuestion[] = [
  ...
  {id:'v101-expert-q-06',type:'quiz',category:'Rois & prophètes',difficulty:'expert',question:'Quel roi de Juda montra ses trésors aux envoyés de Babylone ?',answers:['Ézéchias','Josias','Manassé','Josaphat'],correctAnswer:0,explanation:'Ézéchias leur montra tout ce qui se trouvait dans ses trésors ; Isaïe annonça ensuite que tout serait emporté à Babylone.',reference:'2 Rois 20:12-18'},
  {id:'v101-expert-q-07',type:'quiz',category:'Rois & prophètes',difficulty:'expert',question:'Quel roi demanda de vérifier dans les annales si Mardochée avait été honoré ?',answers:['Assuérus','Darius','Cyrus','Nabuchodonosor'],correctAnswer:0,explanation:'Assuérus fit lire les annales du royaume et découvrit que Mardochée avait autrefois dénoncé un complot.',reference:'Esther 6:1-3'},
  ...
  {id:'v101-expert-q-09',type:'quiz',category:'Évangiles',difficulty:'expert',question:'Quel membre du Sanhédrin vint voir Jésus de nuit et participa à son ensevelissement ?',answers:['Nicodème','Joseph d’Arimathie','Gamaliel','Jaïrus'],correctAnswer:0,explanation:'Nicodème est venu voir Jésus de nuit et a apporté des aromates lors de l’ensevelissement.',reference:'Jean 3:1-2; 19:39-40'},
  {id:'v101-expert-q-10',type:'quiz',category:'Actes',difficulty:'expert',question:'Quel couple retint une partie de l’argent de la vente d’un terrain ?',answers:['Ananias et Saphira','Priscille et Aquilas','Hérode et Bérénice','Félix et Drusille'],correctAnswer:0,explanation:'Ananias et Saphira ont menti au sujet de la somme remise à la congrégation.',reference:'Actes 5:1-10'},
  ...
  {id:'v101-expert-q-12',type:'quiz',category:'Prophéties',difficulty:'expert',question:'Quel prophète vit une corbeille de fruits d’été annonçant la fin d’Israël ?',answers:['Amos','Zacharie','Aggée','Joël'],correctAnswer:0,explanation:'La vision de la corbeille de fruits d’été est rapportée par Amos et annonce que la fin est venue pour le peuple d’Israël.',reference:'Amos 8:1-2'},
];
...
{id:'v102-q-05',type:'quiz',category:'Prophéties',difficulty:'expert',question:'Quel point de départ Daniel 9:25 donne-t-il pour la période menant au Messie ?',answers:['La sortie de la parole pour rétablir et rebâtir Jérusalem','La naissance de David','La destruction du Temple','Le déluge'],correctAnswer:0,explanation:'Daniel 9:25 donne comme point de départ la sortie de la parole concernant Jérusalem.',reference:'Daniel 9:25'},
{id:'v102-q-06',type:'quiz',category:'Prophéties',difficulty:'expert',question:'Quelles deux périodes Daniel 9 mentionne-t-il avant le Messie ?',answers:['Sept semaines et soixante-deux semaines','Trois jours et sept années','Quarante jours et quarante nuits','Douze tribus et soixante-dix rois'],correctAnswer:0,explanation:'Daniel 9:25 mentionne sept semaines puis soixante-deux semaines.',reference:'Daniel 9:25'},
...
{id:'v102-q-10',type:'quiz',category:'Que veulent dire ces versets ?',difficulty:'expert',question:'Pourquoi les chrétiens peuvent-ils se décharger de leurs inquiétudes sur Dieu ?',answers:['Parce qu’il se soucie d’eux','Parce qu’ils n’auront jamais de difficultés','Parce qu’ils connaissent toutes les réponses','Parce qu’ils sont déjà parfaits'],correctAnswer:0,explanation:'Le passage donne comme raison que Dieu se soucie d’eux.',reference:'1 Pierre 5:6-7'},
