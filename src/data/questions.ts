...
const extraFacts: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quel signe a attiré l’attention de Moïse au début de sa mission ?', ['Un buisson ardent','Une colonne de feu','Un arc-en-ciel','Une pluie de cailles'], 0, 'Moïse a vu un buisson en feu qui ne brûlait pas.', 'Exode 3:1-6', 'Bible'],
  ...
  ['Quelle parabole de Jésus illustre la joie de retrouver ce qui avait été égaré ?', ['La brebis perdue','Le semeur','Les dix vierges','Le bon Samaritain'], 0, 'Jésus a utilisé l’exemple d’une brebis perdue pour illustrer la valeur de retrouver ce qui est perdu.', 'Luc 15:3-7', 'Évangiles'],
  ['Quelle parabole raconte l’accueil d’un père envers son fils qui revient après avoir quitté sa maison ?', ['Le fils perdu','Les talents','Le bon Samaritain','Le riche insensé'], 0, 'Le père accueille avec joie son fils qui revient.', 'Luc 15:11-24', 'Évangiles'],
  ...
  ['Quel homme Jésus a-t-il guéri selon le récit où ses disciples l’interrogent sur l’origine de sa cécité ?', ['Un homme né aveugle','Bartimée','Zachée','Un paralysé'], 0, 'Jésus a guéri un homme qui était aveugle depuis sa naissance.', 'Jean 9:1-7', 'Évangiles'],
...
const extraFacts2: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quelle femme venue d’un royaume lointain a interrogé Salomon pour éprouver sa sagesse ?', ['La reine de Saba','Esther','Jézabel','Athalie'], 0, 'La reine de Saba est venue à Jérusalem et a posé des questions difficiles à Salomon.', '1 Rois 10:1-10', 'Rois & prophètes'],
...
const extraFacts3: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quelle veuve a accueilli Élie dans une ville de la région de Sidon ?', ['Une veuve de Sarepta','La veuve de Jéricho','La veuve de Noémi','La veuve de Nabal'], 0, 'Une veuve de Sarepta a accueilli Élie malgré ses ressources limitées.', '1 Rois 17:8-16', 'Rois & prophètes'],
...
const jwQuizExpansion: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quel personnage a demandé à Jésus ce qu’il devait faire pour hériter de la vie éternelle ?', ['Un homme riche','Zachée','Nicodème','Jairus'], 0, 'Un homme riche a posé cette question à Jésus.', 'Matthieu 19:16-22', 'Évangiles'],
