...
const extraFacts2: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quel homme a apporté l’Arche à Jérusalem avec beaucoup de joie sous le règne de David ?', ['David','Salomon','Samuel','Abiatar'], 0, 'David a organisé le transfert de l’Arche à Jérusalem.', '2 Samuel 6:1-15', 'Rois & prophètes'],
...
const extraFacts3: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quel homme a été appelé « le fidèle » dans un contexte de service à Jérusalem après l’exil ?', ['Néhémie','Esdras','Hanania','Zorobabel'], 0, 'Néhémie est présenté comme un homme fidèle dans le récit.', 'Néhémie 7:2', 'Personnages'],
...
const jwQuizExpansion: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quel roi a ordonné de reconstruire Jérusalem après l’exil ?', ['Artaxerxès','Saül','Ézéchias','Hérode'], 0, 'Artaxerxès a autorisé Néhémie à reconstruire les murailles.', 'Néhémie 2:1-8', 'Rois & prophètes'],
  ...
  ['Quel homme a été appelé par Samuel alors qu’il était encore enfant ?', ['Samuel','David','Josué','Daniel'], 0, 'Samuel a commencé à servir au sanctuaire alors qu’il était jeune.', '1 Samuel 3:1-10', 'Personnages'],
...
const quoteQuestions2: QuoteQuestion[] = [
  ...
  { id:'quote-13', type:'quote', category:'Humilité', difficulty:'hard', quote:'Quel roi a demandé du discernement plutôt que la richesse ou une longue vie ?', answers:['Salomon','David','Ézéchias','Josias'], correctAnswer:0, explanation:'Salomon a demandé un cœur obéissant et du discernement pour juger le peuple.', reference:'1 Rois 3:5-12' },
...
const baseQuoteQuestions: QuoteQuestion[] = [
  ...
  { id:'quote-7', type:'quote', category:'Sagesse', difficulty:'medium', quote:'Quel roi a demandé surtout de la sagesse et du discernement pour gouverner ?', answers:['Salomon','David','Ézéchias','Josias'], correctAnswer:0, explanation:'Salomon a demandé un cœur obéissant et du discernement pour juger le peuple.', reference:'1 Rois 3:5-12' },
  { id:'quote-8', type:'quote', category:'Courage', difficulty:'medium', quote:'Quelle femme a choisi d’affronter un danger personnel pour défendre son peuple ?', answers:['Esther','Ruth','Abigaïl','Déborah'], correctAnswer:0, explanation:'Esther a accepté de risquer sa vie en allant voir le roi.', reference:'Esther 4:15-16' },
...
const editorialQuoteQuestions: QuoteQuestion[] = [
  ...
  {id:'v89-q-34',type:'quote',category:'Personnages',difficulty:'hard',quote:'Je n’ai pas mérité ce qui m’arrive, mais je continuerai à faire confiance à Dieu.',answers:['Job','Joseph','Daniel','Néhémie'],correctAnswer:0,explanation:'Le livre de Job présente ses épreuves et ses paroles de fidélité au milieu de la souffrance.',reference:'Job 1:20-22; 2:9-10'},
...
const v90IntruderReasoning: IntruderQuestion[] = [
  ...
  {id:'v90-i-004',type:'intruder',category:'Évangiles',difficulty:'medium',items:['Pierre','Paul','Barnabé','Néhémie'],intruder:3,explanation:'Les trois premiers sont des prédicateurs chrétiens du Ier siècle ; Néhémie appartient à une période bien antérieure.',reference:'Actes 4:8-12; 13:2-3; 15:35-39; Néhémie 1:1'},
  ...
  {id:'v90-i-013',type:'intruder',category:'Évangiles',difficulty:'medium',items:['Marie','Marthe','Élisabeth','Lydie'],intruder:3,explanation:'Les trois premières sont des femmes rencontrées dans les récits liés à Jésus et à sa naissance ; Lydie apparaît dans le livre des Actes.',reference:'Luc 1:5-45; Jean 11:1-5; Luc 1:26-38; Actes 16:14-15'},
  {id:'v90-i-014',type:'intruder',category:'Personnages',difficulty:'medium',items:['Goliath','Samson','Saül','Daniel'],intruder:3,explanation:'Les trois premiers sont associés à des récits de combat ou de puissance militaire ; Daniel est surtout connu pour son activité à la cour et ses visions.',reference:'1 Samuel 17; Juges 13–16; 1 Samuel 10; Daniel 1–7'},
  ...
  {id:'v90-i-018',type:'intruder',category:'Évangiles',difficulty:'medium',items:['Nazareth','Capharnaüm','Bethléem','Samarie'],intruder:3,explanation:'Les trois premières sont des villes ; la Samarie désigne une région et aussi un cadre géographique plus large dans les récits.',reference:'Matthieu 2:23; Matthieu 4:13; Luc 2:4-7; Jean 4:4-5'},
];
