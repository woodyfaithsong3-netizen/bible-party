...
const extraFacts: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quel prisonnier en Égypte a demandé à l’échanson et au panetier de lui raconter leurs rêves ?', ['Joseph', 'Daniel', 'Samuel', 'Néhémie'], 0, 'Joseph a remarqué la tristesse de l’échanson et du panetier et leur a demandé pourquoi ils étaient préoccupés.', 'Genèse 40:5-8', 'Personnages'],
...
const extraFacts4: Array<[string, string[], number, string, string, string]> = [
  ...
  ['Quel roi a achevé la construction du temple de Jérusalem commencé sous son règne ?', ['David', 'Salomon', 'Josias', 'Ézéchias'], 1, 'Salomon a achevé la construction du temple et l’a inauguré à Jérusalem.', '1 Rois 6:14, 37-38; 8:1-21', 'Rois & prophètes'],
