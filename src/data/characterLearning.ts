...
export const characterLearning: Record<string, CharacterLearning> = {
  ...
  "samson": {
    ...
    "difficulties":     [
      "Elle a dû supporter les souffrances et la mort de Jésus, auquel elle était profondément attachée.",
      "Après la mort de Jésus, elle a dû agir avec foi malgré le chagrin et devenir un témoin de sa résurrection."
    ]
  },
  "zacchaeus": {
    ...
    "difficulties":     [
      "Il devait faire face à la mauvaise réputation liée à son métier de collecteur d’impôts et à l’hostilité de son entourage.",
      "Après avoir rencontré Jésus, il devait démontrer par ses actes que sa repentance était sincère, notamment en réparant les torts commis."
    ]
  },
  "barnabas": {
    ...
    "difficulties":     [
      "Il a dû encourager des disciples dans une congrégation en pleine expansion et soutenir Saul malgré les réserves de certains chrétiens.",
      "Son désaccord avec Paul au sujet de Jean-Marc montre qu’il devait gérer des différences de jugement avec un compagnon de service."
    ]
  },
  "cornelius": {
    ...
    "difficulties":     [
      "Il devait comprendre comment Dieu allait accueillir les non-Juifs dans la congrégation chrétienne, alors qu’il n’était pas juif.",
      "Il devait accepter les directives reçues par l’intermédiaire de l’ange et de Pierre et agir immédiatement."
    ]
  },
  "hagar": {
    ...
    "difficulties":     [
      "Elle a subi une situation familiale difficile comme servante de Sara et mère d’un fils qui ne serait pas l’héritier promis.",
      "Elle a dû quitter temporairement la maisonnée d’Abraham et affronter le désert avec Ismaël."
    ]
  },
  "leah": {
    ...
    "difficulties":     [
      "Elle a vécu une situation conjugale douloureuse, car Jacob aimait davantage Rachel.",
      "Elle a dû partager sa vie familiale avec une sœur qui était aussi sa rivale et supporter les tensions liées à cette situation."
    ]
  },
  "esau": {
    ...
    "difficulties":     [
      "Il a perdu le droit d’aînesse et la bénédiction destinés à Jacob et a longtemps ressenti de la colère envers son frère.",
      "Ses choix matrimoniaux ont aussi causé du chagrin à ses parents et l’ont éloigné des priorités spirituelles de la famille."
    ]
  },
  "melchizedek": {
    ...
    "difficulties":     [
      "Son apparition dans le récit biblique est brève, et beaucoup de détails sur sa vie ne sont pas révélés.",
      "Il a exercé simultanément les fonctions de roi de Salem et de prêtre du Dieu Très-Haut, dans un contexte différent de la prêtrise lévitique ultérieure."
    ]
  },
  "jethro": {
    ...
    "difficulties":     [
      "Il devait conseiller Moïse sur l’organisation d’un peuple nombreux tout en respectant l’autorité que Jéhovah avait donnée à Moïse.",
      "Il a observé de près les effets de la fatigue de Moïse et l’a encouragé à déléguer certaines responsabilités."
    ]
  },
  "zipporah": {
    ...
    "difficulties":     [
      "Elle a dû vivre avec les lourdes responsabilités liées à la mission de Moïse et aux déplacements d’Israël.",
      "Lors d’un épisode critique, elle a pris une décision rapide pour protéger la vie de son mari."
    ]
  },
  "korah": {
  ...
  "balak": {
    ...
    "difficulties":     [
      "Il a été profondément inquiet face à l’arrivée d’Israël et a cherché à obtenir une malédiction contre lui.",
      "Il a dû constater que Balaam ne pouvait pas prononcer une malédiction contraire à la volonté de Jéhovah."
    ]
  },
  "eli": {
    ...
    "difficulties":     [
      "Il devait exercer des responsabilités de grand prêtre et de juge tout en corrigeant ses fils, dont la conduite était très mauvaise.",
      "Il a supporté le jugement de Jéhovah concernant sa maison lorsque ses fils ont persisté dans leur mauvaise conduite."
    ]
  },
  "hannah": {
    ...
    "difficulties":     [
      "Elle a supporté pendant des années les moqueries et la détresse liées à sa stérilité.",
      "Elle a ensuite dû remettre Samuel au service de Jéhovah après l’avoir consacré à celui-ci."
    ]
  },
  "michal": {
    ...
    "difficulties":     [
      "Elle a vécu dans une famille royale marquée par les tensions entre Saül et David.",
      "Son mariage avec David et ses réactions à certaines de ses décisions ont créé des tensions dans leur couple."
    ]
  },
  "joab": {
    ...
    "difficulties":     [
      "Il a servi comme chef militaire de David dans un contexte de guerres et de rivalités internes.",
      "Il a pris des initiatives violentes qui ont parfois contredit la volonté de David et ont finalement entraîné un jugement contre lui."
    ]
  },
  "herod_antipas": {
  ...
  "isaiah": {
    ...
    "difficulties":     [
      "Il a dû transmettre des messages de jugement et d’espoir à une nation qui n’écoutait pas toujours les avertissements prophétiques.",
      "Il a servi pendant plusieurs règnes et dans une période de fortes menaces militaires autour de Juda."
    ]
  },
  "jeremiah": {
    ...
    "difficulties":     [
      "Il a annoncé des messages impopulaires à une nation qui refusait souvent de les écouter.",
      "Il a subi l’opposition, les mauvais traitements et l’emprisonnement tout en continuant sa mission prophétique."
    ]
  },
  "ezekiel": {
    ...
    "difficulties":     [
      "Il a dû exercer son ministère parmi les exilés à Babylone dans une situation nationale et religieuse très difficile.",
      "Jéhovah lui a demandé d’accomplir des actes symboliques exigeants et de transmettre des messages de jugement à un peuple souvent rebelle."
    ]
  },
  "ezra": {
    ...
    "difficulties":     [
      "Il devait enseigner la Loi à une communauté revenue d’exil et corriger des pratiques contraires à l’alliance.",
      "Il a dû gérer des problèmes familiaux et religieux sensibles tout en appelant le peuple à se réformer."
    ]
  },
  "zerubbabel": {
    ...
    "difficulties":     [
      "Il devait diriger la reconstruction du temple malgré l’opposition et les interruptions.",
      "Il devait encourager une communauté revenue d’exil qui disposait de moyens limités et avait besoin de retrouver confiance."
    ]
  },
  "haggai": {
  ...
  "micah": {
    ...
    "difficulties": ["Il annonçait un jugement contre Juda et Israël à une époque de forte injustice sociale et d’infidélité religieuse.","Il devait rester fidèle à son message malgré l’opposition des dirigeants et des faux prophètes."]
  },
  "obadiah": {
    ...
    "difficulties": ["Il annonçait un jugement contre Édom dans un contexte de violence et de réjouissance face au malheur de Juda.","Le livre donne peu d’informations personnelles sur lui, ce qui limite ce qu’on peut affirmer sur ses difficultés personnelles."]
  },
  "joel": {
    ...
    "difficulties": ["La date exacte de son activité n’est pas établie avec certitude, ce qui limite les détails chronologiques disponibles.","Il annonçait un jour de jugement tout en appelant le peuple à revenir à Jéhovah de tout son cœur."]
  },
  "nahum": {
    ...
    "difficulties": ["Il devait annoncer la chute de Ninive, capitale d’une puissance redoutée, dans un contexte international instable.","Son message de jugement était sévère et pouvait être difficile à transmettre à ceux qui comptaient sur la puissance assyrienne."]
  },
  "zechariah_priest": {
    ...
    "difficulties": ["Il devait accepter avec foi l’annonce angélique d’une naissance alors que lui et Élisabeth étaient âgés.","Il resta temporairement muet après avoir douté du message de Gabriel et dut attendre l’accomplissement de la promesse."]
  },
  "elizabeth": {
    ...
    "difficulties": ["Elle avait longtemps vécu sans enfant, ce qui lui causait de la honte dans sa société.","Elle devait accepter une grossesse exceptionnelle à un âge avancé et préparer son fils à son rôle particulier."]
  },
  "joseph_jesus_father": {
    ...
    "difficulties": ["Il devait décider comment agir après avoir appris que Marie était enceinte avant leur mariage.","Il devait protéger Jésus et Marie en suivant rapidement les directives reçues en songe, notamment en fuyant en Égypte."]
  },
  "joseph_caiaphas": {
  ...
  "joanna": {
    ...
    "difficulties": ["Elle suivait Jésus tout en ayant un lien avec la maison d’Hérode par son mari Chuza.","Elle devait utiliser ses ressources pour soutenir Jésus et ses disciples malgré l’opposition croissante."]
  },
  "samaritan_leper": {
    ...
    "difficulties": ["Comme Samaritain, il appartenait à un peuple avec lequel les Juifs entretenaient des tensions.","Après sa guérison, il devait reconnaître avec gratitude l’intervention de Jésus alors que les autres lépreux guéris n’étaient pas revenus."]
  },
  "woman_issue_blood": {
    ...
    "difficulties": ["Elle souffrait depuis douze ans d’un problème de santé qui l’épuisait et lui avait coûté beaucoup d’argent.","Elle devait surmonter la crainte et la honte liées à son état pour s’approcher de Jésus."]
  },
  "gerasene_man": {
    ...
    "difficulties": ["Il vivait dans une situation extrêmement difficile et était décrit comme étant sous l’influence de démons.","Après sa délivrance, il devait accepter de ne pas accompagner Jésus mais de retourner chez lui pour raconter ce que Dieu avait fait pour lui."]
  },
  "jason_thessalonica": {
    ...
    "difficulties": ["Sa maison fut prise pour cible par une foule qui cherchait Paul et Silas.","Il fut traîné devant les autorités et dut répondre à des accusations concernant les prédicateurs chrétiens."]
  },
  "onesiphorus": {
    ...
    "difficulties": ["Il soutenait Paul alors que celui-ci était emprisonné et n’avait pas honte de ses chaînes.","Il devait rechercher Paul avec courage dans Rome et lui apporter du réconfort au moment où beaucoup d’autres l’avaient abandonné."]
  },
  "mary_mother_james": {
    ...
    "difficulties": ["Elle faisait partie des femmes qui suivirent Jésus et furent témoins de sa mort et de sa résurrection.","Elle devait faire face au chagrin lié à la mort de Jésus et continuer à soutenir ses disciples après sa résurrection."]
  },
  "mary_mark_mother": {
    ...
    "difficulties": ["Sa maison servait de lieu de réunion pour de nombreux disciples à Jérusalem.","Elle devait soutenir la congrégation alors qu’Hérode faisait persécuter certains chrétiens et avait fait exécuter Jacques."]
  },
  "apphia": {
  ...
  "john_mark": {
    ...
    "difficulties": ["Il abandonna temporairement Paul et Barnabas lors du premier voyage missionnaire, ce qui provoqua ensuite un désaccord entre eux.","Il devait regagner la confiance de Paul et démontra plus tard son utilité dans le service chrétien."]
  },
  "priscilla": {
    ...
    "difficulties": ["Elle devait collaborer étroitement avec Aquila et participer à l’enseignement chrétien dans différents endroits.","Avec Aquila, elle expliqua à Apollos plus exactement la voie de Dieu, ce qui demandait tact et maîtrise des Écritures."]
  },
  "claudius_lycias": {
    ...
    "difficulties": ["Il devait maintenir l’ordre à Jérusalem dans une période de fortes tensions autour de Paul.","Il prit des mesures pour protéger Paul contre une foule puis dut organiser son transfert vers Césarée sous escorte."]
  },
  "julius_centurion": {
    ...
    "difficulties": ["Il devait conduire Paul et d’autres prisonniers jusqu’à Rome dans des conditions maritimes dangereuses.","Il fit preuve de considération envers Paul, mais devait aussi répondre aux exigences de sa fonction et protéger les prisonniers."]
  },
  "gaius_macedonian": {
    ...
    "difficulties": ["Il fut entraîné dans la foule lors de l’émeute d’Éphèse alors que Démétrius et d’autres artisans s’opposaient à la prédication de Paul.","Il devait supporter une situation chaotique sans pouvoir facilement se faire entendre devant la foule."]
  },
  "aristarchus": {
    ...
    "difficulties": ["Il accompagna Paul malgré les dangers du ministère et fut entraîné dans l’émeute d’Éphèse.","Il resta associé à Paul pendant ses déplacements et fut avec lui durant le voyage vers Rome."]
  },
  "syntyche": {
