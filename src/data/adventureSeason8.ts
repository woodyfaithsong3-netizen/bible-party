...
{id:'eternal-life',number:116,title:'Qui aura la vie éternelle ?',icon:'❤️',intro:'La dernière histoire pose une question essentielle : que faut-il faire pour obtenir la vie éternelle ? Il faut apprendre à connaître Jéhovah et Jésus et agir en accord avec ce qu’ils enseignent.',keyPoint:'Connaître Jéhovah et Jésus implique plus que mémoriser des informations : il faut aussi agir en accord avec leur volonté.',quality:{title:'Proche',text:'Jéhovah veut que les humains apprennent à le connaître et développent une vraie relation avec lui.'},questions:[{id:'r116a',type:'quiz',prompt:'Que faut-il apprendre à connaître pour obtenir la vie éternelle ?',choices:[{label:'Jéhovah et Jésus',correct:true},{label:'Les rois d’Égypte',correct:false},{label:'Les dirigeants romains',correct:false},{label:'Les prophètes de Babylone',correct:false}]},{id:'r116b',type:'quiz',prompt:'Connaître Jéhovah et Jésus signifie-t-il seulement mémoriser des informations ?',choices:[{label:'Non, il faut aussi agir en accord avec leur volonté',correct:true},{label:'Oui, rien d’autre ne compte',correct:false},{label:'Oui, il suffit de connaître leurs noms',correct:false},{label:'Non, il faut seulement connaître les dates',correct:false}]}],},
] as AdventureEpisode[],
} as const;