...
export const SEASON_1 = {
  ...
  subtitle: 'De la création au Déluge',
  ...
  episodes: [
    ...
    },
    {
      ...
      keyPoint: 'Genèse 3:15 est la première prophétie biblique et ouvre le fil de la promesse.',
      questions: [
        { id: 'promise-q1', type: 'quiz', prompt: 'Quel verset lance le fil de la promesse ?', choices: [{ label: 'Genèse 3:15', correct: true }, { label: 'Genèse 1:1', correct: false }, { label: 'Genèse 6:9', correct: false }, { label: 'Genèse 12:1', correct: false }] },
    ...
    },
    {
      ...
      keyPoint: 'Après le Déluge, Dieu établit une alliance avec Noé et donne l’arc-en-ciel comme signe.',
      questions: [
