...
const quizSeeds: QuizSeed[] = [
  ...
  ['Salomon a demandé quoi pour bien juger le peuple ?', ['La sagesse','La richesse','La force','La victoire'],0,'Salomon a demandé un cœur obéissant et la sagesse pour bien juger le peuple.','1 Rois 3:5-12','Questions bibliques'],
  ...
  // VERSets
  ['Que signifie le « commencement » de Genèse 1:1 ?', ['Le début de la création des cieux et de la terre','La naissance de Moïse','Le début du règne de David','Le début de l’exil'],0,'Genèse 1:1 introduit le récit de la création.','Genèse 1:1','Que veulent dire ces versets ?','easy'],
  ...
  ['Quelle promesse accompagne Exode 20:12 ?', ['Le commandement est lié à une vie longue dans le pays donné par Dieu','Pour obtenir la royauté','Pour devenir prêtre','Pour recevoir des richesses'],0,'Le commandement est accompagné d’une promesse concernant la durée de vie dans le pays.','Exode 20:12','Que veulent dire ces versets ?','easy'],
  ['Que montre Psaume 23:4 sur Dieu ?', ['Il rassure dans les situations sombres','Il promet une vie sans aucune difficulté','Il interdit toute tristesse','Il demande de ne jamais quitter sa maison'],0,'Le psaume exprime la confiance en la protection divine même dans les moments difficiles.','Psaume 23:4','Que veulent dire ces versets ?'],
  ['Que faut-il reconnaître selon Psaume 46:10 ?', ['Reconnaître sa souveraineté et lui faire confiance','Rester silencieux toute sa vie','Ne plus travailler','Quitter sa famille'],0,'Le verset appelle à reconnaître la position unique de Dieu et à lui faire confiance.','Psaume 46:10','Que veulent dire ces versets ?'],
  ...
  ['Quel conseil donne Jacques 1:19 ?', ['Être prompt à écouter, lent à parler et lent à se mettre en colère','Parler vite et écouter peu','Répondre immédiatement avec colère','Éviter toute conversation'],0,'Jacques donne ce conseil pratique sur la maîtrise de soi et l’écoute.','Jacques 1:19','Que veulent dire ces versets ?'],
  ['Comment l’amour est-il décrit en 1 Corinthiens 13 ?', ['Il se manifeste par la patience, la bonté et l’endurance','Il dépend de la richesse','Il exige d’avoir toujours raison','Il évite toute correction'],0,'Paul décrit des qualités concrètes de l’amour.','1 Corinthiens 13:4-7','Que veulent dire ces versets ?'],
  // HISTOIRE
  ...
  ['À quoi servent les manuscrits anciens ?', ['Comparer les copies anciennes','Ils donnent le nom de chaque copiste','Ils remplacent toutes les traductions','Ils datent tous de l’époque de Jésus'],0,'La comparaison des manuscrits aide à étudier la transmission du texte.','Luc 4:16-21','La Bible et l’Histoire'],
  ...
  ['Quelle ville est tombée après 7 jours de marche ?', ['Jéricho','Rome','Athènes','Tarse'],0,'Le récit de Josué raconte la chute des murailles de Jéricho.','Josué 6:1-20','La Bible et l’Histoire'],
  ...
  ['Quel roi est nommé par Isaïe ?', ['Cyrus','Darius','Assuérus','Artaxerxès'],0,'Isaïe mentionne Cyrus par son nom dans une prophétie.','Isaïe 44:28–45:1','La Bible et l’Histoire'],
  ['Quel empire est le 4e animal de Daniel 7 ?', ['Rome','Égypte','Babylone','Grèce'],0,'Dans l’interprétation classique présentée dans Daniel, le quatrième royaume succède aux trois premiers.','Daniel 7:7, 23','La Bible et l’Histoire'],
  ['À quoi servent les chapitres et versets ?', ['Faciliter la recherche d’un passage','Ils font partie du texte original de chaque manuscrit','Ils indiquent la langue parlée par Jésus','Ils donnent la date exacte de chaque événement'],0,'La numérotation facilite la consultation et les renvois entre passages.','Luc 4:16-21','La Bible et l’Histoire'],
  ...
  ['Que prévoyait la Loi en cas de maladie cutanée ?', ['Une période d’isolement et un examen par le prêtre','Une cérémonie royale','Un voyage en Égypte','Une interdiction de se laver'],0,'Le texte décrit des périodes d’isolement et des examens.','Lévitique 13:1-5','La Bible et la science'],
  ['Quelle pratique concernait la purification par l’eau ?', ['Des règles de lavage et de purification','Une interdiction de boire','Une obligation de ne jamais se baigner','Une interdiction de puiser de l’eau'],0,'La Loi comportait de nombreuses règles liées à la propreté et aux ablutions.','Lévitique 15:5-13','La Bible et la science'],
