...
export const BIBLE_BOOKS: BibleBook[] = [
  ...
  {id:'job',number:18,name:'Job',section:'hebrew',category:'Poèmes',writer:'Moïse',compositionPlace:'Désert',writtenBy:'Jéhovah',completionDate:'v. 1473 av. n. è.',status:'adventure',adventureEpisodes:[13],note:'Aucune histoire principale dédiée : prévoir une découverte courte du livre.'},
  {id:'psalms',number:19,name:'Psaumes',section:'hebrew',category:'Poèmes',writer:'David et d’autres',compositionPlace:'—',writtenBy:'Jéhovah',completionDate:'v. 460 av. n. è.',status:'adventure',adventureEpisodes:[62]},
  {id:'proverbs',number:20,name:'Proverbes',section:'hebrew',category:'Poèmes',writer:'Salomon ; Agour ; Lemouel',compositionPlace:'Jérusalem',writtenBy:'Jéhovah',completionDate:'v. 717 av. n. è.',status:'adventure',adventureEpisodes:[65]},
  {id:'ecclesiastes',number:21,name:'Ecclésiaste',section:'hebrew',category:'Poèmes',writer:'Salomon',compositionPlace:'Jérusalem',writtenBy:'Jéhovah',completionDate:'av. 1000 av. n. è.',status:'adventure',adventureEpisodes:[66]},
  {id:'song-of-solomon',number:22,name:'Chant de Salomon',section:'hebrew',category:'Poèmes',writer:'Salomon',compositionPlace:'Jérusalem',writtenBy:'Jéhovah',completionDate:'v. 1020 av. n. è.',status:'adventure',adventureEpisodes:[64]},
  ...
  {id:'lamentations',number:25,name:'Lamentations',section:'hebrew',category:'Prophéties',writer:'Jérémie',compositionPlace:'À proximité de Jérusalem',writtenBy:'Jéhovah',completionDate:'607 av. n. è.',status:'adventure',adventureEpisodes:[76]},
  {id:'ezekiel',number:26,name:'Ézéchiel',section:'hebrew',category:'Prophéties',writer:'Ézéchiel',compositionPlace:'Babylone',writtenBy:'Jéhovah',completionDate:'v. 591 av. n. è.',status:'adventure',adventureEpisodes:[75],note:'Ne pas l’associer artificiellement à l’histoire 76.'},
  ...
  {id:'hosea',number:28,name:'Osée',section:'hebrew',category:'Prophéties',writer:'Osée',compositionPlace:'Samarie (district)',writtenBy:'Jéhovah',completionDate:'apr. 745 av. n. è.',status:'adventure',adventureEpisodes:[68]},
  ...
  {id:'romans',number:45,name:'Romains',section:'greek',category:'Lettres',writer:'Paul',compositionPlace:'Corinthe',writtenBy:'Jéhovah',completionDate:'v. 56 de n. è.',status:'adventure',adventureEpisodes:[110]},
  {id:'1-corinthians',number:46,name:'1 Corinthiens',section:'greek',category:'Lettres',writer:'Paul',compositionPlace:'Éphèse',writtenBy:'Jéhovah',completionDate:'v. 55 de n. è.',status:'adventure',adventureEpisodes:[108]},
  {id:'2-corinthians',number:47,name:'2 Corinthiens',section:'greek',category:'Lettres',writer:'Paul',compositionPlace:'Macédoine',writtenBy:'Jéhovah',completionDate:'v. 55 de n. è.',status:'adventure',adventureEpisodes:[109]},
  {id:'galatians',number:48,name:'Galates',section:'greek',category:'Lettres',writer:'Paul',compositionPlace:'Corinthe ou Antioche de Syrie',writtenBy:'Jéhovah',completionDate:'v. 50-52 de n. è.',status:'adventure',adventureEpisodes:[104]},
  {id:'ephesians',number:49,name:'Éphésiens',section:'greek',category:'Lettres',writer:'Paul',compositionPlace:'Rome',writtenBy:'Jéhovah',completionDate:'v. 60-61 de n. è.',status:'adventure',adventureEpisodes:[113]},
  {id:'philippians',number:50,name:'Philippiens',section:'greek',category:'Lettres',writer:'Paul',compositionPlace:'Rome',writtenBy:'Jéhovah',completionDate:'v. 60-61 de n. è.',status:'adventure',adventureEpisodes:[113]},
  {id:'colossians',number:51,name:'Colossiens',section:'greek',category:'Lettres',writer:'Paul',compositionPlace:'Rome',writtenBy:'Jéhovah',completionDate:'v. 60-61 de n. è.',status:'adventure',adventureEpisodes:[113]},
  {id:'1-thessalonians',number:52,name:'1 Thessaloniciens',section:'greek',category:'Lettres',writer:'Paul',compositionPlace:'Corinthe',writtenBy:'Jéhovah',completionDate:'v. 50 de n. è.',status:'adventure',adventureEpisodes:[110]},
  {id:'2-thessalonians',number:53,name:'2 Thessaloniciens',section:'greek',category:'Lettres',writer:'Paul',compositionPlace:'Corinthe',writtenBy:'Jéhovah',completionDate:'v. 51 de n. è.',status:'adventure',adventureEpisodes:[110]},
  {id:'1-timothy',number:54,name:'1 Timothée',section:'greek',category:'Lettres',writer:'Paul',compositionPlace:'Macédoine',writtenBy:'Jéhovah',completionDate:'v. 61-64 de n. è.',status:'adventure',adventureEpisodes:[113],note:'Prévoir une découverte dédiée à 1 Timothée.'},
  {id:'2-timothy',number:55,name:'2 Timothée',section:'greek',category:'Lettres',writer:'Paul',compositionPlace:'Rome',writtenBy:'Jéhovah',completionDate:'v. 65 de n. è.',status:'adventure',adventureEpisodes:[113]},
  ...
  {id:'hebrews',number:58,name:'Hébreux',section:'greek',category:'Lettres',writer:'Paul',compositionPlace:'Rome',writtenBy:'Jéhovah',completionDate:'v. 61 de n. è.',status:'adventure',adventureEpisodes:[113]},
  ...
  {id:'1-peter',number:60,name:'1 Pierre',section:'greek',category:'Lettres',writer:'Pierre',compositionPlace:'Babylone',writtenBy:'Jéhovah',completionDate:'v. 62-64 de n. è.',status:'adventure',adventureEpisodes:[114]},
  {id:'2-peter',number:61,name:'2 Pierre',section:'greek',category:'Lettres',writer:'Pierre',compositionPlace:'Babylone (?)',writtenBy:'Jéhovah',completionDate:'v. 64 de n. è.',status:'adventure',adventureEpisodes:[115]},
  {id:'1-john',number:62,name:'1 Jean',section:'greek',category:'Lettres',writer:'Apôtre Jean',compositionPlace:'Éphèse, ou à proximité',writtenBy:'Jéhovah',completionDate:'v. 98 de n. è.',status:'adventure',adventureEpisodes:[115]},
  {id:'2-john',number:63,name:'2 Jean',section:'greek',category:'Lettres',writer:'Apôtre Jean',compositionPlace:'Éphèse, ou à proximité',writtenBy:'Jéhovah',completionDate:'v. 98 de n. è.',status:'adventure',adventureEpisodes:[115]},
  {id:'3-john',number:64,name:'3 Jean',section:'greek',category:'Lettres',writer:'Apôtre Jean',compositionPlace:'Éphèse, ou à proximité',writtenBy:'Jéhovah',completionDate:'v. 98 de n. è.',status:'adventure',adventureEpisodes:[115]},
